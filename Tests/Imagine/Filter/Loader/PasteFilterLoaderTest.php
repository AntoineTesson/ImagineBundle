...
use Skies\Bundle\ImagineBundle\Imagine\Filter\Loader\PasteFilterLoader;
...
class PasteFilterLoaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function shouldReturnPasteFilter()
    {
        ...
        $this->assertInstanceOf('Skies\\Bundle\\ImagineBundle\\Imagine\\Filter\\PasteFilter', $result);
    }
