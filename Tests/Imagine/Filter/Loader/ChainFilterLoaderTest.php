<?php
namespace Skies\Bundle\ImagineBundle\Tests\Imagine\Filter\Loader;

use Skies\Bundle\ImagineBundle\Imagine\Filter\Loader\ChainFilterLoader;
use Symfony\Component\DependencyInjection\Container;
use Skies\Bundle\ImagineBundle\Tests\Imagine\Filter\Loader\Files\Filter;
...
class ChainFilterLoaderTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @test
     * @expectedException \InvalidArgumentException
     * @expectedExceptionMessage Instance of "Skies\Bundle\ImagineBundle\Imagine\Filter\Loader\LoaderInterface" expected
     */
    ...
    public function shouldReturnChainFilter()
    {
        ...
        $this->assertInstanceOf('Skies\\Bundle\\ImagineBundle\\Imagine\\Filter\\ChainFilter', $result);
    }

    /**
     * @return \PHPUnit_Framework_MockObject_MockObject|\Skies\Bundle\ImagineBundle\Imagine\Filter\Loader\LoaderInterface
     */
    protected function createFilterLoaderMock()
    {
        return $this->getMock('Skies\\Bundle\\ImagineBundle\\Imagine\\Filter\\Loader\\LoaderInterface');
    }
}