...
use Skies\Bundle\ImagineBundle\Imagine\Filter\ChainFilter;

class ChainFilterLoader implements LoaderInterface
{
    /**
     * @var \Skies\Bundle\ImagineBundle\Imagine\Filter\FilterManager
     */
    protected $filterManager;

    /**
     * @param \Skies\Bundle\ImagineBundle\Imagine\Filter\FilterManager $filterManager
     */
